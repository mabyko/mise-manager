...
[![Node 26과 Node 24의 업데이트를 각각 보여 주는 Mise Manager 앱 창과 메뉴바 화면](./docs/images/mise-manager-overview.png)](./docs/images/mise-manager-overview.png)

**앱 창:** 도구를 찾고, 설치된 각 major 계열의 업데이트를 확인하고, 전역 버전을 관리합니다. **메뉴바:** 작은 창에서 업데이트를 확인하고 새 버전을 설치하거나 사용할 버전을 전환합니다.

원본 크기로 보기: [앱 창](./docs/images/mise-manager-app.png) · [메뉴바 화면](./docs/images/mise-manager-menu-bar.png)
...
- **업데이트**에서 도구의 각 버전 계열, mise, 외부 플러그인의 업데이트를 한 목록으로 확인합니다. 사이드바 배지와 macOS 메뉴바에 같은 업데이트 수가 표시되며, 확인하지 못했거나 확인에 실패한 항목도 보여 줍니다.
