// Derives the Debug app icon from the release master (Lift·Graphite): same glyph, plus a red "DEV" badge top-right.
...
let badge = NSRect(x: 540, y: 760, width: 280, height: 110)
